...
#include <mHstFsw/Top/mHstFswTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    mHstFsw::setupTopology(inputs);
    mHstFsw::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    mHstFsw::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
