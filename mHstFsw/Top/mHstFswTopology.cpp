// ======================================================================
// \title  mHstFswTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <mHstFsw/Top/mHstFswTopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
//#include <mHstFsw/Top/mHstFswPacketsAc.hpp>
...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::mHstFsw_blockDrv::WARN, PingEntries::mHstFsw_blockDrv::FATAL, "blockDrv"},
    {PingEntries::mHstFsw_tlmSend::WARN, PingEntries::mHstFsw_tlmSend::FATAL, "chanTlm"},
    {PingEntries::mHstFsw_cmdDisp::WARN, PingEntries::mHstFsw_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::mHstFsw_cmdSeq::WARN, PingEntries::mHstFsw_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::mHstFsw_eventLogger::WARN, PingEntries::mHstFsw_eventLogger::FATAL, "eventLogger"},
    {PingEntries::mHstFsw_fileDownlink::WARN, PingEntries::mHstFsw_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::mHstFsw_fileManager::WARN, PingEntries::mHstFsw_fileManager::FATAL, "fileManager"},
    {PingEntries::mHstFsw_fileUplink::WARN, PingEntries::mHstFsw_fileUplink::FATAL, "fileUplink"},
    {PingEntries::mHstFsw_prmDb::WARN, PingEntries::mHstFsw_prmDb::FATAL, "prmDb"},
    {PingEntries::mHstFsw_rateGroup1::WARN, PingEntries::mHstFsw_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::mHstFsw_rateGroup2::WARN, PingEntries::mHstFsw_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::mHstFsw_rateGroup3::WARN, PingEntries::mHstFsw_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology() {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(mHstFswPacketsPkts, mHstFswPacketsIgnore, 1);
