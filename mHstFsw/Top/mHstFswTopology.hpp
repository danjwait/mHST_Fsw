// ======================================================================
// \title  mHstFswTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef MHSTFSW_MHSTFSWTOPOLOGY_HPP
#define MHSTFSW_MHSTFSWTOPOLOGY_HPP
// Included for access to mHstFsw::TopologyState and mHstFsw::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <mHstFsw/Top/mHstFswTopologyDefs.hpp>

// Remove unnecessary mHstFsw:: qualifications
 ...
 * mHstFsw::TopologyState see: mHstFswTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type mHstFsw::TopologyState see: mHstFswTopologyDefs.hpp.
 *
